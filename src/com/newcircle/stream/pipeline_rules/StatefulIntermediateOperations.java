...
/**
 * Stream can process element sequentially Streams can process elements in
 * parallel Therefore stream operations are not allowed to modify the stream
 ...
 *
 * - distinct, limit, skip, sorted normally use in multi-threading
 *
 */
